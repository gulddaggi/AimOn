...
import com.example.ffp_be.auth.dto.response.ListDataResponse;
import com.example.ffp_be.auth.dto.response.SingleDataResponse;
...
public class ResponseService {
    ...
    public <T> SingleDataResponse<T> getSingleDataResponse(boolean success, String message,
        T data) {
